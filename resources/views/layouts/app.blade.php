            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ route('login') }}" class="btn-transition bg-cyan-500 text-white px-6 py-3 rounded-full hover:bg-cyan-600">
                            Login
                        </a>
                        <a href="{{ route('register') }}" class="btn-transition bg-gray-100 text-cyan-500 px-6 py-3 rounded-full hover:bg-gray-200 border border-cyan-500">
                            Register
                        </a>
                    </div>
                </div>
