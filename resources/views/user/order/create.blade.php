                ...
                <form action="{{ route('user.order.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-teal-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-teal-600 font-bold">Rp {{ number_format($service->service_price, 0, ',', '.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-gray-700 font-medium mb-2" for="notes">Special Notes</label>
